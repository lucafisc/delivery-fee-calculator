    ...
    <div className="flex flex-col">
      ...
      <div className="flex items-center">
        <input
          ...
          onBlur={blurHandle}
          className="w-full border border-white rounded-xl text-black font-bold p-2 px-6 mt-2 text-right bg-slate-800 text-white text-3xl h-16
          hover:cursor-select focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
        ></input>
        <span
