    ...
    <div className="flex flex-col">
      ...
      <div className="flex items-center">
        <input
          ...
          onBlur={blurHandle}
          className="w-full h-16 p-2 px-6 mt-2 text-3xl font-bold text-right text-black text-white border border-zinc-500 rounded-xl bg-zinc-800 hover:cursor-select focus:outline-none focus:ring-2 focus:ring-orange-600 focus:border-transparent"
        ></input>
        <span
